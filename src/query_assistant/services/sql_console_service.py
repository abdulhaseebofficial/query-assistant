...
what may run â€” one read-only SELECT, tables from a whitelist â€” and a query typed by
...
from query_assistant.domain.query.csv_engine import get_dataset_info
...
def _demo_tables(conn):
    ...
    already exists as DDL â€” and the copy shown to somebody writing a query is the
