...
the same database as the demo tables and holds addresses people typed in — so, like
...
# bind it at import have to be repointed one by one whenever the database moves — the
# test suite keeps a list of them — and a module added later is a module somebody
