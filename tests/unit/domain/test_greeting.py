...
The wording lives in one place (services/greeting_service.py) and the browser script is
...
from query_assistant.services.greeting_service import BANDS, greet, phrase_for_hour, phrases_by_hour
