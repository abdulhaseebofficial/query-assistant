"""The AI engine executes model-generated SQL, so validate_select() is the
...
def validate(sql):
    return validate_select(sql, BUILTIN_TABLES)
...
def test_tables_outside_the_whitelist_are_rejected(table):
    ...
    data â€” the whitelist is the only thing keeping generated SQL away from them."""
