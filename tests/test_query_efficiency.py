...
Neither of these was slow enough to notice against the demo database — five tables
...
class TestReferenceDataIsOneQuery:
    ...
    def test_a_single_round_trip(self, test_database):
        from backend.engines.rule_engine import get_reference_data
    ...
    def test_every_list_is_still_returned(self, conn):
        from backend.engines.rule_engine import REFERENCE_KINDS, get_reference_data
...
class TestDescribingOneTableDoesNotTouchTheOthers:
    ...
    def connected_db(self, tmp_path, monkeypatch):
        import backend.connectors.sqlite_connector as sqlite_connector
...
class TestPatternsAreBuiltOnce:
    ...
    def test_the_same_word_list_yields_the_same_compiled_pattern(self):
        from backend.engines.rule_engine import EMPLOYEE_WORDS, _any_of_pattern
    ...
    def test_matching_is_unchanged_by_the_alternation(self):
        ...
        from backend.engines.rule_engine import EMPLOYEE_WORDS, any_word_in, word_in
    ...
    def test_a_word_is_not_matched_inside_a_longer_one(self):
        from backend.engines.rule_engine import any_word_in
