"""Questions asked the way they're actually asked here — Roman Urdu, or mixed with
...
* answered from the right table with a filter silently dropped — "IT walay
...
class TestDepartmentFilterIsNotDropped:
    ...
    English word "it" — and the Roman Urdu cue comes *after* the name, not before.
...
class TestAggregates:
    ...
    def test_totalling_an_amount_beats_counting_rows(self):
        ...
        how much, not how many — and it used to answer how many."""
